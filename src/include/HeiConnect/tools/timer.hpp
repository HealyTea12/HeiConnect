...
namespace HeiConnect::tools
{
                    ...
                    if (!m_checkpoints.empty())
                    {
                        ...
                        for (const auto& checkpoint : m_checkpoints)
                        {
                            auto checkpoint_duration =
                                std::chrono::duration_cast<std::chrono::milliseconds>(checkpoint.second - previous)
                                    .count();
    ...
    private:
        ...
        std::vector<std::pair<std::string, std::chrono::time_point<std::chrono::high_resolution_clock>>>
            m_checkpoints{};
    };
